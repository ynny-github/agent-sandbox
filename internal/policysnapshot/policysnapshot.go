...
// the agent could not edit. That routing is gone — execd now interprets
...
// It is the single source of truth for this path; the execd socket
// (internal/claude) and `agent-sandbox doctor`'s execd-readiness check both
